...
let Guests = ['Alina', 'Saba', 'Maryam'];

let Notcomming = (Guests[1])
console.log(Notcomming);

//replacing the name of the guest who can’t make it with the name of the new person:
let newguest = "Sana"

Guests[Guests.indexOf(Notcomming)] = newguest;
console.log(Guests);

//• Print a second set of invitation messages:

Guests.forEach (Guests => {
    console.log(`Dear ${Guests} I would like to invite you to dinner.`);
})